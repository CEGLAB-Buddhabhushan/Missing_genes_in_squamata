...
sed -i 's/-/_/g' final_output.tsv
awk 'BEGIN{OFS="\t"} NR==1 {print $0, "Gene_status"; next} $2=="Squamata" {print $0, "Loss"; next} {print $0, "Intact"}' final_output.tsv > final_output_with_status.tsv
cut -f3 final_output.tsv|tail -n+2 > species_tree.lst
