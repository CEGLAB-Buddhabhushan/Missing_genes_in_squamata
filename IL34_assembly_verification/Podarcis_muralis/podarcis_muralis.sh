...
species5="Podarcis_muralis"  
for fastq in *.fastq.gz
do
  /media/lokdeep/sdf/BUDDHA/BMCBIO/IL34_long_read_verification/minimap2-2.28_x64-linux/minimap2 -ax map-ont -t 36 ../"$species5".fa $fastq | samtools sort -@36 -O BAM - > ${fastq%.fastq.gz}.bam
  samtools index ${fastq%.fastq.gz}.bam                   
done
...
#######__________Klumpy_______________#################################################

klumpy scan_alignments --alignment_map SRR8468506.bam  --threads 32  --annotation /media/lokdeep/sdf/BUDDHA/BMCBIO/IL34_long_read_verification/Podarcis_muralis/GCF_004329235.1_PodMur_1.0_genomic.gtf

klumpy find_gaps --fasta  /media/lokdeep/sdf/BUDDHA/BMCBIO/IL34_long_read_verification/Podarcis_muralis/Podarcis_muralis.fa

klumpy alignment_plot --alignment_map SRR8468506.bam --reference NC_041319.1 --candidates  SRR8468506_Candidate_Regions.tsv  --window_size 10000 --window_step 5000 --color red --vertical_line_gaps --vertical_line_klumps --format svg  --leftbound 39114790 --rightbound 39128268 --annotation /media/lokdeep/sdf/BUDDHA/BMCBIO/IL34_long_read_verification/Podarcis_muralis/GCF_004329235.1_PodMur_1.0_genomic.gtf --gap_file Podarcis_muralis_gaps.tsv --height 1500 --width 3500 --min_len 8000  --vertical_line_exons   --number
...
species3="Podarcis_muralis" 
genome=/media/lokdeep/sdf/BUDDHA/BMCBIO/IL34_long_read_verification/Podarcis_muralis/Nanopore/Podarcis_muralis.fa 
for query in IL34_query_multispecies.fa Sphenodon_punctatus_IL34_Exons.fa
do
