...
~/software/hyphy-2.5.43rc/HYPHYMP fel --alignment $i --tree  "$j"_treeLabled.txt --branches fg --resample 10 >"$j"_treeoutput_fel
done
done
...
/usr/bin/Rscript ../../FEL_plot.R HYPHY_FEL_merged_data.tsv
cd ../..
