...
~/software/hyphy-2.5.43rc/HYPHYMP meme --alignment $i --tree  "$j"_treeLabled.txt --branches fg --resample 10 >"$j"_treeoutput_meme
done
done
...
/usr/bin/Rscript ../../MEME_plot.R HYPHY_MEME_merged_data.tsv
cd ../..
