      seqfile = CSF1R.aln.faa * sequence data filename
     treefile = Rhinolophus_ferrumequinum.nwk      * tree structure file name
      outfile = Rhinolophus_ferrumequinum_F1x4_bneutral.out        * main result file name
